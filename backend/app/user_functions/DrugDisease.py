...
from app.user_functions.ncats.scripts.Q2_main import Q2_query
import numpy as np
import os
import datetime
...
class Options(object):
    def __init__(self, verbose=True, batchFile=None, gen_image=False, gen_pubmed=False, outPath=results_dir, gene_list=[]):
...
class DrugGenes(IrisCommand):
    ...
    def explanation(self, result):
        ...
        query_statement = 'How does ' + result['drug'] + ' affect: ' + ', '.join(result['disease_genes']) + '?'
